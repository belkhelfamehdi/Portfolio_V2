  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl rounded-lg border border-neon-green shadow-[0_0_60px_#00FFB3] p-2 bg-black/90">
        ...
        <div className="grid md:grid-cols-3 gap-6 h-[440px]">
          ...
          <div className="flex flex-col justify-between items-center border border-neon-green rounded-md p-4 bg-black shadow-[0_0_15px_#00FFB3] relative">
            ...
            <div className="flex-1 flex items-center justify-center relative z-10">
              <img
                src={Photo}
                alt="Belkhelfa Mehdi"
                className="w-52 h-52 object-cover rounded-sm border border-neon-green shadow-[0_0_20px_#00FFB3]"
              />
            </div>

            {/* Name and Status */}
            <div className="mt-2 w-full text-center relative z-10">
              <div className="text-lg font-bold tracking-widest text-neon-green font-mono border-t border-neon-green pt-2">
                BELKHELFA MEHDI
              </div>
              <div className="text-sm text-neon-green font-mono mt-1 animate-flicker">
                [ ACTIVE ]
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2 border border-neon-green rounded-md p-4 bg-black shadow-[0_0_15px_#00FFB3] relative flex flex-col">
            <div className="text-xs text-neon-green mb-2 tracking-wide">
              :: USER DATA STREAM
            </div>

            <div className="flex-1 rounded-md border border-neon-green bg-black/80 shadow-[0_0_20px_#00FFB3] p-3 overflow-y-auto">
              <TerminalSim />
            </div>
          </div>
        </div>
